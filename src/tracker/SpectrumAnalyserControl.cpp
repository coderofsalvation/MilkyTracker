...
SpectrumAnalyserControl::SpectrumAnalyserControl(pp_int32 id, 
...
void SpectrumAnalyserControl::paint(PPGraphicsAbstract* g)
{
	if (!isVisible())
		return;
...
void SpectrumAnalyserControl::buildColorLUT()
{
	struct TColorKey
	{
		PPColor color;

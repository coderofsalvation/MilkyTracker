...
private:
	...
	enum MenuCommandIDs
	{
		...
		MenuCommandIDResonantFilterLP,
		MenuCommandIDResonantFilterHP,
		MenuCommandIDResonantFilterBP,
		MenuCommandIDResonantFilterNOTCH,
		MenuCommandIDFilterSweep,
		MenuCommandIDReverberate,
		MenuCommandIDSelectiveEQ10Band,
		MenuCommandIDExcite,
		MenuCommandIDBassboost,
		MenuCommandIDCapturePattern,
		MenuCommandIDGenerateRandomNote,
...
private:
	...
	public:
		enum SampleToolTypes
		{
			...
			SampleToolTypeBitshift,
			SampleToolTypeReverberate,
			SampleToolTypeExcite,
			...
			SampleToolTypeModulateFilter,
			SampleToolTypeModulateEnvelope,
			SampleToolTypeResonantFilterLP,
			SampleToolTypeResonantFilterHP,
			SampleToolTypeResonantFilterBP,
			SampleToolTypeResonantFilterNOTCH,
			SampleToolTypeFilterSweep,

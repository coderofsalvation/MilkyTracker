...
void Tracker::initKeyBindings()
{
	...
	eventKeyDownBindingsMilkyTracker->addBinding('H', KeyModifierCTRL|KeyModifierALT, &Tracker::eventKeyDownBinding_InvokeSectionHDRecorder);	
	eventKeyDownBindingsMilkyTracker->addBinding('R', KeyModifierCTRL|KeyModifierALT, &Tracker::eventKeyDownBinding_InvokeScriptRepeat);	
  ...
  eventKeyDownBindingsMilkyTracker->addBinding('H', KeyModifierCTRL, &Tracker::eventKeyDownBinding_InvokeHelp);
	...
	eventKeyDownBindingsFastTracker->addBinding('H', KeyModifierCTRL, &Tracker::eventKeyDownBinding_InvokeSectionHDRecorder);	
	eventKeyDownBindingsFastTracker->addBinding('R', KeyModifierCTRL, &Tracker::eventKeyDownBinding_InvokeScriptRepeat);	
...
void Tracker::eventKeyDownBinding_InvokeScriptRepeat()
{
	if (screen->getModalControl())
		return;

	sectionSamples->getSampleEditorControl()->executeScriptContextMenu(-1);
}
